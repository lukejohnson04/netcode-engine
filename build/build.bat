...
set Includes= /I "../" /I "B:/frameworks/SDL2-2.28.4/include" /I "B:/frameworks/SDL2_ttf-2.20.2/include" /I "B:\frameworks\SDL2_mixer-2.8.0\include" /I "B:\frameworks\SDL2_image-2.6.3\include" /I "B:\frameworks\glew-2.1.0\include"
